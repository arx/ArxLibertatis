...
bool CALLBACK PathwayOptionsProc(HWND hWnd, unsigned int uMsg, WPARAM wParam, LPARAM);
bool CALLBACK StartProc(HWND hWnd, unsigned int uMsg, WPARAM wParam, LPARAM);
...
INT  CALLBACK AboutProc(HWND, unsigned int, WPARAM, LPARAM);
bool CALLBACK OptionsProc(HWND hWnd, unsigned int uMsg, WPARAM wParam, LPARAM lParam);
bool CALLBACK GaiaTextEdit(HWND hWnd, unsigned int uMsg, WPARAM wParam, LPARAM lParam);
...
bool CALLBACK LanguageOptionsProc(HWND hWnd, unsigned int uMsg, WPARAM wParam, LPARAM lParam);
bool CALLBACK PrecalcProc(HWND hWnd, unsigned int uMsg, WPARAM wParam, LPARAM lParam);
bool CALLBACK PassProc(HWND hWnd, unsigned int uMsg, WPARAM wParam, LPARAM lParam);
bool CALLBACK IDDErrorLogProc(HWND hWnd, unsigned int uMsg, WPARAM wParam, LPARAM lParam);
bool CALLBACK MeshReductionProc(HWND hWnd, unsigned int uMsg, WPARAM wParam,
                                LPARAM lParam);
bool CALLBACK ScriptSearchProc(HWND hWnd, unsigned int uMsg, WPARAM wParam,
                               LPARAM lParam);
