...
extern LRESULT CALLBACK ShowTextDlg(HWND hDlg, unsigned int message, WPARAM wParam, LPARAM lParam);
extern LRESULT CALLBACK ShowVarsDlg(HWND hDlg, unsigned int message, WPARAM wParam, LPARAM lParam);
