...
SampleId SND_SPELL_FIRE_PROTECTION_LOOP(INVALID_ID); // © Dimoks
SampleId SND_SPELL_FIRE_PROTECTION_END(INVALID_ID); // © Dimoks
...
SampleId SND_SPELL_ICE_FIELD_LOOP(INVALID_ID); // © Dimoks
SampleId SND_SPELL_ICE_FIELD_END(INVALID_ID); // © Dimoks
SampleId SND_SPELL_ICE_PROJECTILE_LAUNCH(INVALID_ID);
SampleId SND_SPELL_INCINERATE(INVALID_ID);
SampleId SND_SPELL_INCINERATE_LOOP(INVALID_ID); // © Dimoks
SampleId SND_SPELL_INCINERATE_END(INVALID_ID); // © Dimoks
...
SampleId SND_SPELL_RUNE_OF_GUARDING_END(INVALID_ID); // © Dimoks
...
static void ARX_SOUND_CreateStaticSamples() {
	...
	SND_SPELL_FIRE_PROTECTION_LOOP     = audio::createSample("magic_spell_fire_protection_loop.wav"); // © Dimoks
	SND_SPELL_FIRE_PROTECTION_END      = audio::createSample("magic_spell_fire_protection_end.wav"); // © Dimoks
	...
	SND_SPELL_ICE_FIELD_LOOP           = audio::createSample("magic_spell_ice_fieldloop.wav"); // © Dimoks
	SND_SPELL_ICE_FIELD_END            = audio::createSample("magic_spell_ice_field_end.wav"); // © Dimoks
	...
	SND_SPELL_INCINERATE_LOOP          = audio::createSample("magic_spell_incinerate_loop.wav"); // © Dimoks
	SND_SPELL_INCINERATE_END           = audio::createSample("magic_spell_incinerate_end.wav"); // © Dimoks
	...
	SND_SPELL_RUNE_OF_GUARDING_END     = audio::createSample("magic_spell_rune_of_guarding_explode.wav"); // © Dimoks
...
static void ARX_SOUND_ReleaseStaticSamples() {
	...
	SND_SPELL_FIRE_PROTECTION_LOOP = INVALID_ID; // © Dimoks
	SND_SPELL_FIRE_PROTECTION_END = INVALID_ID; // © Dimoks
	...
	SND_SPELL_ICE_FIELD_LOOP = INVALID_ID; // © Dimoks
	SND_SPELL_ICE_FIELD_END = INVALID_ID; // © Dimoks
	SND_SPELL_ICE_PROJECTILE_LAUNCH = INVALID_ID;
	SND_SPELL_INCINERATE = INVALID_ID;
	SND_SPELL_INCINERATE_LOOP = INVALID_ID; // © Dimoks
	SND_SPELL_INCINERATE_END = INVALID_ID; // © Dimoks
	...
	SND_SPELL_RUNE_OF_GUARDING_END = INVALID_ID; // © Dimoks
