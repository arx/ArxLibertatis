...
static void ARX_SOUND_ReleaseStaticSamples() {
	...
	// Interface samples
	g_snd.BACKPACK = audio::SourcedSample();
	g_snd.BOOK_OPEN = audio::SourcedSample();
	g_snd.BOOK_CLOSE = audio::SourcedSample();
	g_snd.BOOK_PAGE_TURN = audio::SourcedSample();
	g_snd.GOLD = audio::SourcedSample();
	g_snd.INVSTD = audio::SourcedSample();
	g_snd.SCROLL_OPEN = audio::SourcedSample();
	g_snd.SCROLL_CLOSE = audio::SourcedSample();
	g_snd.TORCH_START = audio::SourcedSample();
	g_snd.TORCH_LOOP = audio::SourcedSample();
	g_snd.TORCH_END = audio::SourcedSample();

	// Other SFX samples
	g_snd.FIREPLACE = audio::SourcedSample();
	g_snd.PLOUF = audio::SourcedSample();
	g_snd.QUAKE = audio::SourcedSample();

	// Menu samples
	g_snd.MENU_CLICK = audio::SourcedSample();
	g_snd.MENU_RELEASE = audio::SourcedSample();

	// Player samples
	g_snd.PLAYER_DEATH_BY_FIRE = audio::SourcedSample();
	g_snd.PLAYER_HEART_BEAT = audio::SourcedSample();
	g_snd.PLAYER_LEVEL_UP = audio::SourcedSample();
	g_snd.PLAYER_POISONED = audio::SourcedSample();

	// Magic drawing samples
	g_snd.MAGIC_AMBIENT = audio::SourcedSample();
	g_snd.MAGIC_DRAW = audio::SourcedSample();
	g_snd.MAGIC_FIZZLE = audio::SourcedSample();

	// Magic symbols samples
	g_snd.SYMB[RUNE_AAM] = audio::SourcedSample();
	g_snd.SYMB[RUNE_CETRIUS] = audio::SourcedSample();
	g_snd.SYMB[RUNE_COSUM] = audio::SourcedSample();
	g_snd.SYMB[RUNE_COMUNICATUM] = audio::SourcedSample();
	g_snd.SYMB[RUNE_FOLGORA] = audio::SourcedSample();
	g_snd.SYMB[RUNE_FRIDD] = audio::SourcedSample();
	g_snd.SYMB[RUNE_KAOM] = audio::SourcedSample();
	g_snd.SYMB[RUNE_MEGA] = audio::SourcedSample();
	g_snd.SYMB[RUNE_MORTE] = audio::SourcedSample();
	g_snd.SYMB[RUNE_MOVIS] = audio::SourcedSample();
	g_snd.SYMB[RUNE_NHI] = audio::SourcedSample();
	g_snd.SYMB[RUNE_RHAA] = audio::SourcedSample();
	g_snd.SYMB[RUNE_SPACIUM] = audio::SourcedSample();
	g_snd.SYMB[RUNE_STREGUM] = audio::SourcedSample();
	g_snd.SYMB[RUNE_TAAR] = audio::SourcedSample();
	g_snd.SYMB[RUNE_TEMPUS] = audio::SourcedSample();
	g_snd.SYMB[RUNE_TERA] = audio::SourcedSample();
	g_snd.SYMB[RUNE_VISTA] = audio::SourcedSample();
	g_snd.SYMB[RUNE_VITAE] = audio::SourcedSample();
	g_snd.SYMB[RUNE_YOK] = audio::SourcedSample();

	// Spells samples
	g_snd.SPELL_ACTIVATE_PORTAL = audio::SourcedSample();
	g_snd.SPELL_ARMOR_START = audio::SourcedSample();
	g_snd.SPELL_ARMOR_END = audio::SourcedSample();
	g_snd.SPELL_ARMOR_LOOP = audio::SourcedSample();
	g_snd.SPELL_LOWER_ARMOR = audio::SourcedSample();
	g_snd.SPELL_LOWER_ARMOR_END = audio::SourcedSample();
	g_snd.SPELL_BLESS = audio::SourcedSample();
	g_snd.SPELL_COLD_PROTECTION_START = audio::SourcedSample();
	g_snd.SPELL_COLD_PROTECTION_LOOP = audio::SourcedSample();
	g_snd.SPELL_COLD_PROTECTION_END = audio::SourcedSample();
	g_snd.SPELL_CONFUSE = audio::SourcedSample();
	g_snd.SPELL_CONTROL_TARGET = audio::SourcedSample();
	g_snd.SPELL_CREATE_FIELD = audio::SourcedSample();
	g_snd.SPELL_CREATE_FOOD = audio::SourcedSample();
	g_snd.SPELL_CURE_POISON = audio::SourcedSample();
	g_snd.SPELL_CURSE = audio::SourcedSample();
	g_snd.SPELL_DETECT_TRAP = audio::SourcedSample();
	g_snd.SPELL_DETECT_TRAP_LOOP = audio::SourcedSample();
	g_snd.SPELL_DISARM_TRAP = audio::SourcedSample();
	g_snd.SPELL_DISPELL_FIELD = audio::SourcedSample();
	g_snd.SPELL_DISPELL_ILLUSION = audio::SourcedSample();
	g_snd.SPELL_DOUSE = audio::SourcedSample();
	g_snd.SPELL_ELECTRIC = audio::SourcedSample();
	g_snd.SPELL_EXPLOSION = audio::SourcedSample();
	g_snd.SPELL_EYEBALL_IN = audio::SourcedSample();
	g_snd.SPELL_EYEBALL_OUT = audio::SourcedSample();
	g_snd.SPELL_FIRE_HIT = audio::SourcedSample();
	g_snd.SPELL_FIRE_LAUNCH = audio::SourcedSample();
	g_snd.SPELL_FIRE_PROTECTION = audio::SourcedSample();
	g_snd.SPELL_FIRE_PROTECTION_LOOP = audio::SourcedSample();
	g_snd.SPELL_FIRE_PROTECTION_END = audio::SourcedSample();
	g_snd.SPELL_FIRE_WIND = audio::SourcedSample();
	g_snd.SPELL_FREEZETIME = audio::SourcedSample();
	g_snd.SPELL_HARM = audio::SourcedSample();
	g_snd.SPELL_HEALING = audio::SourcedSample();
	g_snd.SPELL_ICE_FIELD = audio::SourcedSample();
	g_snd.SPELL_ICE_FIELD_LOOP = audio::SourcedSample();
	g_snd.SPELL_ICE_FIELD_END = audio::SourcedSample();
	g_snd.SPELL_ICE_PROJECTILE_LAUNCH = audio::SourcedSample();
	g_snd.SPELL_INCINERATE = audio::SourcedSample();
	g_snd.SPELL_INCINERATE_LOOP = audio::SourcedSample();
	g_snd.SPELL_INCINERATE_END = audio::SourcedSample();
	g_snd.SPELL_IGNITE = audio::SourcedSample();
	g_snd.SPELL_INVISIBILITY_START = audio::SourcedSample();
	g_snd.SPELL_INVISIBILITY_END = audio::SourcedSample();
	g_snd.SPELL_LEVITATE_START = audio::SourcedSample();
	g_snd.SPELL_LEVITATE_LOOP = audio::SourcedSample();
	g_snd.SPELL_LEVITATE_END = audio::SourcedSample();
	g_snd.SPELL_LIGHTNING_START = audio::SourcedSample();
	g_snd.SPELL_LIGHTNING_LOOP = audio::SourcedSample();
	g_snd.SPELL_LIGHTNING_END = audio::SourcedSample();
	g_snd.SPELL_MAGICAL_HIT = audio::SourcedSample();

	g_snd.SPELL_FIRE_FIELD_START = audio::SourcedSample();
	g_snd.SPELL_FIRE_FIELD_LOOP = audio::SourcedSample();
	g_snd.SPELL_FIRE_FIELD_END = audio::SourcedSample();

	g_snd.SPELL_MAGICAL_SHIELD = audio::SourcedSample();
	g_snd.SPELL_MASS_INCINERATE = audio::SourcedSample();
	g_snd.SPELL_MASS_PARALYSE = audio::SourcedSample();
	g_snd.SPELL_MM_CREATE = audio::SourcedSample();
	g_snd.SPELL_MM_HIT = audio::SourcedSample();
	g_snd.SPELL_MM_LAUNCH = audio::SourcedSample();
	g_snd.SPELL_MM_LOOP = audio::SourcedSample();
	g_snd.SPELL_NEGATE_MAGIC = audio::SourcedSample();
	g_snd.SPELL_PARALYSE = audio::SourcedSample();
	g_snd.SPELL_PARALYSE_END = audio::SourcedSample();
	g_snd.SPELL_POISON_PROJECTILE_LAUNCH = audio::SourcedSample();
	g_snd.SPELL_RAISE_DEAD = audio::SourcedSample();
	g_snd.SPELL_REPEL_UNDEAD = audio::SourcedSample();
	g_snd.SPELL_REPEL_UNDEAD_LOOP = audio::SourcedSample();
	g_snd.SPELL_RUNE_OF_GUARDING = audio::SourcedSample();
	g_snd.SPELL_RUNE_OF_GUARDING_END = audio::SourcedSample();
	g_snd.SPELL_SLOW_DOWN = audio::SourcedSample();
	g_snd.SPELL_SLOW_DOWN_END = audio::SourcedSample();
	g_snd.SPELL_SPARK = audio::SourcedSample();
	g_snd.SPELL_SPEED_START = audio::SourcedSample();
	g_snd.SPELL_SPEED_LOOP = audio::SourcedSample();
	g_snd.SPELL_SPEED_END = audio::SourcedSample();
	g_snd.SPELL_SUMMON_CREATURE = audio::SourcedSample();
	g_snd.SPELL_TELEKINESIS_START = audio::SourcedSample();
	g_snd.SPELL_TELEKINESIS_END = audio::SourcedSample();
	g_snd.SPELL_VISION_START = audio::SourcedSample();
	g_snd.SPELL_VISION_LOOP = audio::SourcedSample();
}
