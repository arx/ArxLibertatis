...
static void CalculateWaterDisplacement(float & fTu, float & fTv, EERIEPOLY * ep,
	...
	switch(step) {
	case(0):fTu = FluidTextureDisplacement(true, p, time, 1000, 200, 1000, 32, 0.f, 0.f);
			fTv = FluidTextureDisplacement(false, p, time, 1000, 200, 1000, 32, 0.f, 0.f);
			break;
	case(1):fTu = FluidTextureDisplacement(true, p, time, 1000, 200, 1000, 28, 30.f, 30);
			...
			break;
	case(2):fTu = FluidTextureDisplacement(true, p, time, 1000, 200, 1000, 40, 60.f, 60, -1.0);
...
static void CalculateLavaDisplacement(float & fTu, float & fTv, EERIEPOLY * ep,
	...
	switch(step) {
	case(0):fTu = FluidTextureDisplacement(true, p, time, 1000, 200, 2000, 20, 0.f, 0.f);
			fTv = FluidTextureDisplacement(false, p, time, 1000, 200, 2000, 20, 0.f, 0.f);
			break;
	case(1):fTu = FluidTextureDisplacement(true, p, time, 1000, 100, 2000, 10, 0.f, 0.f);
			fTv = FluidTextureDisplacement(false, p, time, 1000, 100, 2000, 10, 0.f, 0.f);
			break;
	case(2):fTu = FluidTextureDisplacement(true, p, time, 600, 160, 2000, 11, 0.f, 0.f);
			fTv = FluidTextureDisplacement(false, p, time, 600, 160, 2000, 11, 0.f, 0.f);
			break;
	default:break;
	}
}
