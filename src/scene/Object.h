...
EERIE_3DOBJ * TheoToEerie(unsigned char * adr,long size, const std::string& texpath, const std::string& fic,long flag,LPDIRECT3DDEVICE7 pd3dDevice=NULL,long flag2=0);
void _THEObjLoad(EERIE_3DOBJ *eerie,unsigned char * adr,long * poss,long version,long flag=0,long flag2=0);
EERIE_3DOBJ * TheoToEerie_Fast(const std::string& texpath, const std::string& fic,long flag,LPDIRECT3DDEVICE7 pd3dDevice=NULL);
