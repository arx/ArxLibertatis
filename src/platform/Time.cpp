...
PlatformInstant getTime() {
	...
	return PlatformInstant(0) + std::chrono::microseconds(ts.tv_sec * 1000000ll + ts.tv_nsec / 1000ll);
}
...
PlatformInstant getTime() {
	...
	return PlatformInstant(0) + std::chrono::microseconds(counter.QuadPart * 1000ll / (g_clockFrequency / 1000ll));
}
