...
void StatsPage::manageStats()
{
	...
	// Secondary Attributes
	{
		...
		std::string value = std::to_string(std::ceil(player.Full_maxlife));
	...
	
	{
		...
		std::string value = std::to_string(std::ceil(player.Full_maxmana));
	...
	
	{
		...
		std::string value = std::to_string(std::ceil(player.m_miscFull.damages));
	...
	
	{
		...
		std::string value = std::to_string(std::ceil(player.m_miscFull.armorClass));
	...
	
	{
		...
		std::string value = std::to_string(std::ceil(player.m_miscFull.resistMagic));
	...
	
	{
		...
		std::string value = std::to_string(std::ceil(player.m_miscFull.resistPoison));
