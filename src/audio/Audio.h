...
AmbianceId getAmbiance(const fs::path & ambiance_name);
EnvId getEnvironment(const fs::path & environment_name);
...
aalError getAmbianceName(AmbianceId ambiance_id, fs::path & name);
