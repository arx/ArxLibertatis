...
#define MACRO_MENU_PRINCIPALE(MACRO_button,MACRO_menu,MACRO_locate,MACRO_check){\
        PAK_UNICODE_GetPrivateProfileString( MACRO_locate, "string", "", szMenuText, 256, NULL);\
            ...
            case EDIT_QUEST:
                {
                    ...
                    PAK_UNICODE_GetPrivateProfileString( "system_menus_main_editquest_load", "string", "", szMenuText, 256, NULL);
                    me = new CMenuElementText(BUTTON_MENUEDITQUEST_LOAD_INIT, hFontMenu, szMenuText, 0, 0, lColor, 1.f, EDIT_QUEST_LOAD);
                    pWindowMenuConsole->AddMenuCenter(me);

                    PAK_UNICODE_GetPrivateProfileString( "system_menus_main_editquest_save", "string", "", szMenuText, 256, NULL);
                        ...
                        while(iFirst>=0)
                        {
                            for(iI=1; iI<(save_c); iI++)
                            {
                                ...
                                if( !szMenuText.compare( tex2 ) || !szMenuText1.compare( tex2 ) )
                                {
                                    ...
                                    PAK_UNICODE_GetPrivateProfileString( "system_menus_main_quickloadsave", "string", "Quick", tex, 256, NULL);
            ...
            case OPTIONS:
                {
                    ...
                    PAK_UNICODE_GetPrivateProfileString( "system_menus_options_video", "string", "", szMenuText, 256, NULL);
                    me = new CMenuElementText(BUTTON_MENUOPTIONSVIDEO_INIT, hFontMenu, szMenuText, 0, 0,lColor,1.f,OPTIONS_VIDEO);
                    pWindowMenuConsole->AddMenuCenter(me);
                    
                    PAK_UNICODE_GetPrivateProfileString( "system_menus_options_audio", "string", "", szMenuText, 256, NULL);
                    me = new CMenuElementText(-1, hFontMenu, szMenuText, 0, 0,lColor,1.f,OPTIONS_AUDIO);
                    pWindowMenuConsole->AddMenuCenter(me);
                    
                    PAK_UNICODE_GetPrivateProfileString( "system_menus_options_input", "string", "", szMenuText, 256, NULL);
                ...
                //------------------ START VIDEO
                    ...
                    pc = new CMenuPanel();
                    PAK_UNICODE_GetPrivateProfileString( "system_menus_options_video_resolution", "string", "", szMenuText, 256, NULL);
                    szMenuText += "  ";
                    me = new CMenuElementText(-1, hFontMenu, szMenuText, fPosX1, 0.f, lColor, 1.f, NOP);
                    me->SetCheckOff();
                    pc->AddElement(me);
