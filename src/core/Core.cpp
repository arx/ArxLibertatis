...
TBBUTTON tbButtons [] = 
{
{0, DANAE_B001, TBSTATE_ENABLED, TBSTYLE_BUTTON, TBBUTTON_INIT, 0},
{1, DANAE_B002, TBSTATE_ENABLED, TBSTYLE_BUTTON, TBBUTTON_INIT, 1},
{0, 0, TBSTATE_ENABLED | TBSTATE_WRAP   , TBSTYLE_SEP, TBBUTTON_INIT, 0},
{8, DANAE_B009, TBSTATE_ENABLED, TBSTYLE_BUTTON, TBBUTTON_INIT, 8},
{12, DANAE_B013, TBSTATE_ENABLED, TBSTYLE_BUTTON, TBBUTTON_INIT, 12},

{0, 0, TBSTATE_ENABLED , TBSTYLE_SEP, TBBUTTON_INIT, 0},

{13, DANAE_B003, TBSTATE_ENABLED, TBSTYLE_CHECK, TBBUTTON_INIT, 13},
{16, DANAE_B005, TBSTATE_ENABLED, TBSTYLE_BUTTON, TBBUTTON_INIT, 16},
{0, 0, TBSTATE_ENABLED , TBSTYLE_SEP, TBBUTTON_INIT, 0},
{5, DANAE_B006, TBSTATE_ENABLED, TBSTYLE_BUTTON, TBBUTTON_INIT, 5},
{14, DANAE_B004, TBSTATE_ENABLED, TBSTYLE_CHECK, TBBUTTON_INIT, 14},
{2, DANAE_B007, TBSTATE_ENABLED, TBSTYLE_CHECK, TBBUTTON_INIT, 2},
{3, DANAE_B008, TBSTATE_ENABLED, TBSTYLE_CHECK, TBBUTTON_INIT, 3},
{17, DANAE_B010, TBSTATE_ENABLED, TBSTYLE_CHECK, TBBUTTON_INIT, 17},
{18, DANAE_B011, TBSTATE_ENABLED, TBSTYLE_CHECK, TBBUTTON_INIT, 18},
{11, DANAE_B014, TBSTATE_ENABLED, TBSTYLE_CHECK, TBBUTTON_INIT, 11}, // Particles Button
{0, 0, TBSTATE_ENABLED , TBSTYLE_SEP, TBBUTTON_INIT, 0},
{19, DANAE_B012, TBSTATE_ENABLED, TBSTYLE_BUTTON, TBBUTTON_INIT, 19},
{0, 0, TBSTATE_ENABLED , TBSTYLE_SEP, TBBUTTON_INIT, 0},
{20, DANAE_B015, TBSTATE_ENABLED, TBSTYLE_BUTTON, TBBUTTON_INIT, 20},
{0, 0, TBSTATE_ENABLED , TBSTYLE_SEP, TBBUTTON_INIT, 0},
{21, DANAE_B016, TBSTATE_ENABLED, TBSTYLE_BUTTON, TBBUTTON_INIT, 21},
{0, 0, TBSTATE_ENABLED , TBSTYLE_SEP, TBBUTTON_INIT, 0},
};
