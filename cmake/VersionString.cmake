...
function(parse_version_file names file)
	...
	foreach(line IN LISTS lines)
		...
		if(line MATCHES "^([^ ]*) (.*)$")
			_define_version_line_var(PREFIX CMAKE_MATCH_1)
			_define_version_line_var(LINE CMAKE_MATCH_2)
		else()
		...
		if(line MATCHES "^(.*[^+] )?([^ ]+)( \\+ [^ ]+)?$")
			...
			_define_version_line_var(SUFFIX suffix)
