	...
	if(MSVC)
		if(NOT version LESS 2011 AND MSVC_VERSION LESS 1600)
			if(NOT version LESS 2017 AND NOT MSVC_VERSION LESS 1911)
				...
				set(_HAS_CXX17 1 PARENT_SCOPE)
				set(_HAS_CXX14 1 PARENT_SCOPE)
		...
		if(NOT version LESS 2017 AND FLAG_FOUND OR NOT CMAKE_COMPILER_IS_GNUCXX)
			set(_HAS_CXX17 1 PARENT_SCOPE)
		endif()
		if(NOT version LESS 2014 AND NOT FLAG_FOUND)
			add_cxxflag("-std=c++14")
		endif()
		if(NOT version LESS 2014 AND FLAG_FOUND OR NOT CMAKE_COMPILER_IS_GNUCXX)
			set(_HAS_CXX14 1 PARENT_SCOPE)
		endif()
...
function(check_cxx VER CHECK RESULTVAR)
	if(_HAS_CXX${VER})
		if(MSVC AND ARGC GREATER 2)
			...
			string(REGEX REPLACE "--*$" "" check "${check}")
			set(file "${CXX11_CHECK_DIR}/cxx${VER}-${check}.cpp")
			...
			check_compile(result "${file}" "${CHECK}" "C++${VER} feature")
...
macro(check_cxx11 CHECK RESULTVAR)
	check_cxx(11 ${CHECK} ${RESULTVAR})
endmacro()

macro(check_cxx14 CHECK RESULTVAR)
	check_cxx(14 ${CHECK} ${RESULTVAR})
endmacro()

macro(check_cxx17 CHECK RESULTVAR)
	check_cxx(17 ${CHECK} ${RESULTVAR})
endmacro()
