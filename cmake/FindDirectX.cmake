...
if(WIN32) # The only platform it makes sense to check for DirectX SDK
	...
	# include dir
	find_path(DIRECTX_INCLUDE_DIR NAMES d3d9.h HINTS ${DXSDK_DIR}/include)
	...
	find_library(DIRECTX_D3D9_LIBRARY NAMES d3d9 HINTS ${DXSDK_LIB_DIR} PATH_SUFFIXES ${DIRECTX_LIBPATH_SUFFIX})
	find_library(DIRECTX_D3DX9_LIBRARY NAMES d3dx9 HINTS ${DXSDK_LIB_DIR} PATH_SUFFIXES ${DIRECTX_LIBPATH_SUFFIX})
	find_library(DIRECTX_DXERR9_LIBRARY NAMES dxerr HINTS ${DXSDK_LIB_DIR} PATH_SUFFIXES ${DIRECTX_LIBPATH_SUFFIX})
	find_library(DIRECTX_DXGUID_LIBRARY NAMES dxguid HINTS ${DXSDK_LIB_DIR} PATH_SUFFIXES ${DIRECTX_LIBPATH_SUFFIX})
	find_library(DIRECTX_DINPUT8_LIBRARY NAMES dinput8 HINTS ${DXSDK_LIB_DIR} PATH_SUFFIXES ${DIRECTX_LIBPATH_SUFFIX})
	find_library(DIRECTX_XINPUT_LIBRARY NAMES xinput HINTS ${DXSDK_LIB_DIR} PATH_SUFFIXES ${DIRECTX_LIBPATH_SUFFIX})
	find_library(DIRECTX_DXGI_LIBRARY NAMES dxgi HINTS ${DXSDK_LIB_DIR} PATH_SUFFIXES ${DIRECTX_LIBPATH_SUFFIX})
	find_library(DIRECTX_D3DCOMPILER_LIBRARY NAMES d3dcompiler HINTS ${DXSDK_LIB_DIR} PATH_SUFFIXES ${DIRECTX_LIBPATH_SUFFIX})
